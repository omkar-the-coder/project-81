...
export default class RideScreen extends Component {
    ...
    handleTransaction = async () => {
        ...
        var transactionType =await this.checkBikeAvailability(bikeType)
        ...
        if (!transactionType) {
            ...
            Alert.alert("Kindly enter/scaned valied bike id ");
        ...
        if (bikeRef.docs.length == 0) {
            ...
            bikeRef.docs.map(doc => {
                ...
                if (!doc.data().under_maintenance) {
                    ...
                    transactionType =TransactionType =doc.date().is_bike_available?
                    "rented" :"return"
